...
int lua_cocos2dx_experimental_webview_WebView_setOnShouldStartLoading(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_experimental_webview_WebView_setOnShouldStartLoading'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_experimental_webview_WebView_setOnShouldStartLoading'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_experimental_webview_WebView_setOnShouldStartLoading'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_experimental_webview_WebView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"WebView");
        ...
        tolua_function(tolua_S,"setOnShouldStartLoading",lua_cocos2dx_experimental_webview_WebView_setOnShouldStartLoading);
